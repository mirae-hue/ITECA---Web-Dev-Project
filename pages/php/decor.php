...
<?php endif; ?>
  ...
  <section class="product-section fade-in">
    <div class="product-grid">
      ...
      <div class="product">
        <img src="../img/products/decor/Recycled glass  candle holders (1).jpeg" alt="Recycled glass vases and candle holders" />
      ...
      <div class="product">
        <img src="../img/products/decor/Upcycled wood shelving (1).jpeg" alt="Upcycled wood wall art and shelving" />
        <div class="product-info">
      ...
      <div class="product">
        <img src="../img/products/decor/Organic cotton throw blankets (2).png" alt="Organic cotton throw blankets and cushion covers" />
        <div class="product-info">
      ...
      <div class="product">
        <img src="../img/products/decor/Soy wax candles with natural essential oils (1).png" alt="Soy wax candles with natural essential oils" />
        <div class="product-info">
      ...
      <div class="product">
        <img src="../img/products/decor/Indoor plants with biodegradable pots (1).png" alt="Indoor plants with biodegradable pots" />
        <div class="product-info">
      ...
      <div class="product">
        <img src="../img/products/decor/Eco-friendly paint (1).png" alt="Eco-friendly paint and finishes" />
        <div class="product-info">
